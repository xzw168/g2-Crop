...
extern char nullptrP[100];

#define nullptr_void  ((void*)nullptrP)
#define nullptr_bool  ((bool*)nullptrP)
#define nullptr_float ((float*)nullptrP)
...
#define __USER_DATA                 // 启用用户定义的数据组
#define __STEP_CORRECTION           // 启用虚拟编码器步进校正

/****** DEVELOPMENT SETTINGS ******/

#define __DIAGNOSTICS               // 启用各种调试功能
#define __DIAGNOSTIC_PARAMETERS     // 在config_app中启用系统诊断参数（_xx）
